...
<div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="mb-3">
                <form action="admin-add-beds" method="post">
                    <button class="btn  btn-primary float-end">Add Beds</button>
                </form>
            </div>
  ...
  <tbody>
    ...
    if(isset($beds))
    {
        ...
        <tr>
         ...
         <td>
           <form action="admin-updatebeds" method="post" enctype="multipart/form-data">
              <button class="btn-primary btn-sm" name="update-be" value="<?php echo $value->id ?>">Update</button>
            </form>
