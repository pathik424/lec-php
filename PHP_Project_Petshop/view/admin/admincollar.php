...
<div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="mb-3">
                <form action="admin-add-collar" method="post">
                    <button class="btn  btn-primary float-end">Add Collar</button>
                </form>
            </div>
  ...
  <tbody>
    ...
    if(isset($collar))
    {
        ...
        <tr>
         ...
         <td>
           <form action="admin-updatecollar" method="post" enctype="multipart/form-data">
              <button class="btn-primary btn-sm" name="update-co" value="<?php echo $value->id ?>">Update</button>
            </form>
