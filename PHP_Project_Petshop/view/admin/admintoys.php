...
<div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="mb-3">
                <form action="admin-add-toys" method="post">
                    <button class="btn  btn-primary float-end">Add Toys</button>
                </form>
            </div>
  ...
  <tbody>
    ...
    if(isset($toys))
    {
        ...
        <tr>
         ...
         <td>
           <form action="admin-updatetoys" method="post" enctype="multipart/form-data">
              <button class="btn-primary btn-sm" name="update-to" value="<?php echo $value->id ?>">Update</button>
            </form>
