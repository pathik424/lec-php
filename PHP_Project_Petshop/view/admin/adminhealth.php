...
<div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="mb-3">
                <form action="admin-add-health" method="post">
                    <button class="btn  btn-primary float-end">Add Health Product</button>
                </form>
            </div>
  ...
  <tbody>
    ...
    if(isset($health))
    {
        ...
        <tr>
         ...
         <td>
           <form action="admin-updatehealth" method="post" enctype="multipart/form-data">
              <button class="btn-primary btn-sm" name="update-he" value="<?php echo $value->id ?>">Update</button>
            </form>
